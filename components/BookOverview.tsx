    ...
    <section className="flex flex-col-reverse items-center gap-12 sm:gap-32 md:flex-row">
      <div className="flex flex-1 flex-col gap-5 text-primary">
        ...
        <div className="flex gap-5">
          <p>
            By{' '}
            <span className="font-semibold text-yellow-200">{book.author}</span>
          </p>
          <p>
            Category{' '}
            <span className="font-semibold text-yellow-200">{book.genre}</span>
          </p>
        </div>
        ...
        <p className="pt-5 text-green-800">{book.description}</p>
      ...
      <div className="relative flex flex-1 justify-center">
        <div className="relative">
          <div className="z-10">
            <BookCover cover={book.cover} variant="large" />
          </div>
        </div>
